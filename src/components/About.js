 ...
 const About = () => (
     <div className="about=">
        ...
        <div className="about_bio">
             ...
             <p>I was born and raised in Hood River, Oregon, and I would be thrilled with an opportunity to stay here and work as a software engineer. My family owns a three acre Christmas Tree farm in the valley which I  have loved working on my entire life. </p>
             <p>In my free time I love to enjoy all of which Hood River has to offer, which includes skiing on Mt. Hood in the winter, and boating and wakeboarding on the Columbia River Gorge in the summer. </p>
         </div>
         </Fade> 
     </div>
 )
